...
<body>
        ...
        <section class="row encabezado-pro">
            ...
            <div class="productos pro-1 col-6 col-md-3 col-lg-2 ">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Producto XYZ</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
                    </div>
                </div>
            </div>
            <div class="productos pro-2 col-6 col-md-3 col-lg-2 ">
                <div class="card">
            ...
            <div class="productos pro-3 col-6 col-md-3 col-lg-2 ">
                <div class="card">
            ...
            <div class="productos pro-4  col-6 col-md-3 col-lg-2 ">
                <div class="card">
            ...
            <div class="productos pro-5 col-6 col-md-3 col-lg-2 ">
                <div class="card">
            ...
            <div class="productos pro-6 col-6 col-md-3 col-lg-2 ">
                <div class="card">
    ...
    <section>
        <section class="row encabezado-pro">
            ...
            <div class="productos pro-1 col-6 col-md-3 col-lg-2 ">
                <div class="card">
                    <img src="img/unsplash_0POwK6iAiRQ.png" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Control XYZ</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
                    </div>
                </div>
            ...
            <div class="productos pro-2 col-6 col-md-3 col-lg-2 ">
                <div class="card">
                    <img src="img/unsplash_caNzzoxls8Q.png" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Control y consola XYZ</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
                    </div>
                </div>
            ...
            <div class="productos pro-3 col-6 col-md-3 col-lg-2 ">
                <div class="card">
                    <img src="img/unsplash_ZV7lnfyQLmA.png" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Consola XYZ</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
                    </div>
                </div>
            ...
            <div class="productos pro-4 col-6 col-md-3 col-lg-2 ">
                <div class="card">
                    <img src="img/unsplash_wa5z9o9fgjw.png" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Control XYZ</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
            ...
            <div class="productos pro-5 col-6 col-md-3 col-lg-2 ">
                <div class="card">
                    <img src="img/unsplash_Zjn4dT993-g.png" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Consola XYZ</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
            ...
            <div class="productos pro-6 col-6 col-md-3 col-lg-2 ">
                <div class="card">
                    <img src="img/unsplash_k-xYhI3-gJM.png" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Game Boy Color</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
                    </div>
                </div>
    ...
    <section>
        <section class="row encabezado-pro">
            ...
            <div class="productos pro-1 col-6 col-md-3 col-lg-2 ">
                <div class="card">
                    <img src="img/unsplash_fMP-oCze3AY.png" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Consola Atari</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
                    </div>
                </div>
            ...
            <div class="productos pro-2 col-6 col-md-3 col-lg-2">
                <div class="card">
                    <img src="img/unsplash_bUgaIaZysH0.png" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Camisa SNES</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
                    </div>
                </div>
            ...
            <div class="productos pro-3 col-6 col-md-3 col-lg-2 ">
                <div class="card card-diversos">
                    <img src="img/unsplash_sYVY_ZKwaxU.png" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Control y Consola XYZ</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
            ...
            <div class="productos pro-4 col-6 col-md-3 col-lg-2">
                <div class=" card-diversos">
                    <img src="img/unsplash_jMT6BrgBuXU.png" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Control y Consola XYZ</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
            ...
            <div class="productos pro-5 col-6 col-md-3 col-lg-2 ">
                <div class="card">
                    <img src="img/unsplash_MxVkWPiJALs.png" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Control y Consola XYZ</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
            ...
            <div class="productos pro-6 col-6 col-md-3 col-lg-2 ">
                <div class="card">
                    <img src="img/unsplash_r27umXAelDc.png" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Producto XYZ</h4>
                        <p>$60.00</p>
                        <a href="#">Ver producto</a>
